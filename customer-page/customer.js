...
document.addEventListener('DOMContentLoaded', showdvd);
...
function storeItemDetails(buttonElement) {
    ...
    if (card) {
        ...
        localStorage.setItem('rentItem', JSON.stringify(itemDetails));
    ...
    function showRentPopup() {
        ...
        if (rentItem) {
            ...
            document.getElementById('popup-description').innerText = rentItem.description;
    ...
    function saveDetails() {
        ...
        alert(`You have rented ${rentItem.title} with quantity ${rentItem.quantity} you get the Dvd before 24 hours afater the hour your rent will be cancel `);
...
function showProfile() {
    ...
    function saveDetails() {
        ...
        const cus = customer.find(c => c.username == document.getElementById('name').value)
